...
{         "xc.ldr.b", 0, {"I",0},   "d,s(t)", MATCH_XC_LDR_B, MASK_XC_LDR_B, match_opcode, 0},
{         "xc.ldr.h", 0, {"I",0},   "d,s(t)", MATCH_XC_LDR_H, MASK_XC_LDR_H, match_opcode, 0},
{         "xc.ldr.w", 0, {"I",0},   "d,s(t)", MATCH_XC_LDR_W, MASK_XC_LDR_W, match_opcode, 0},
{         "xc.ldr.d",64, {"I",0},   "d,s(t)", MATCH_XC_LDR_D, MASK_XC_LDR_D, match_opcode, 0},
{        "xc.ldr.bu", 0, {"I",0},   "d,s(t)", MATCH_XC_LDR_BU, MASK_XC_LDR_BU, match_opcode, 0},
{        "xc.ldr.hu", 0, {"I",0},   "d,s(t)", MATCH_XC_LDR_HU, MASK_XC_LDR_HU, match_opcode, 0},
{        "xc.ldr.wu",64, {"I",0},   "d,s(t)", MATCH_XC_LDR_WU, MASK_XC_LDR_WU, match_opcode, 0},
{         "xc.str.b", 0, {"I",0},   "r,s(t)", MATCH_XC_STR_B, MASK_XC_STR_B, match_opcode, 0},
{         "xc.str.h", 0, {"I",0},   "r,s(t)", MATCH_XC_STR_H, MASK_XC_STR_H, match_opcode, 0},
{         "xc.str.w", 0, {"I",0},   "r,s(t)", MATCH_XC_STR_W, MASK_XC_STR_W, match_opcode, 0},
{         "xc.str.d",64, {"I",0},   "r,s(t)", MATCH_XC_STR_D, MASK_XC_STR_D, match_opcode, 0},
{        "xc.mmul.3", 0, {"I",0}, "(XM,XN),s,t,r", MATCH_XC_MMUL_3, MASK_XC_MMUL_3, match_opcode, 0},
...
{           "xc.lut", 0, {"I",0},    "d,s,t", MATCH_XC_LUT, MASK_XC_LUT, match_opcode, 0},
{           "xc.bop", 0, {"I",0}, "d,s,t,Xl", MATCH_XC_BOP, MASK_XC_BOP, match_opcode, 0},
{          "xc.padd", 0, {"I",0}, "Xp,d,s,t", MATCH_XC_PADD, MASK_XC_PADD, match_opcode, 0},
{          "xc.psub", 0, {"I",0}, "Xp,d,s,t", MATCH_XC_PSUB, MASK_XC_PSUB, match_opcode, 0},
{          "xc.pror", 0, {"I",0}, "Xp,d,s,t", MATCH_XC_PROR, MASK_XC_PROR, match_opcode, 0},
{          "xc.psll", 0, {"I",0}, "Xp,d,s,t", MATCH_XC_PSLL, MASK_XC_PSLL, match_opcode, 0},
{          "xc.psrl", 0, {"I",0}, "Xp,d,s,t", MATCH_XC_PSRL, MASK_XC_PSRL, match_opcode, 0},
{        "xc.pror.i", 0, {"I",0}, "Xp,d,s,>", MATCH_XC_PROR_I, MASK_XC_PROR_I, match_opcode, 0},
{        "xc.psll.i", 0, {"I",0}, "Xp,d,s,>", MATCH_XC_PSLL_I, MASK_XC_PSLL_I, match_opcode, 0},
{        "xc.psrl.i", 0, {"I",0}, "Xp,d,s,>", MATCH_XC_PSRL_I, MASK_XC_PSRL_I, match_opcode, 0},
{        "xc.pmul.l", 0, {"I",0}, "Xp,d,s,t", MATCH_XC_PMUL_L, MASK_XC_PMUL_L, match_opcode, 0},
{        "xc.pmul.h", 0, {"I",0}, "Xp,d,s,t", MATCH_XC_PMUL_H, MASK_XC_PMUL_H, match_opcode, 0},
{      "xc.pclmul.l", 0, {"I",0}, "Xp,d,s,t", MATCH_XC_PCLMUL_L, MASK_XC_PCLMUL_L, match_opcode, 0},
{      "xc.pclmul.h", 0, {"I",0}, "Xp,d,s,t", MATCH_XC_PCLMUL_H, MASK_XC_PCLMUL_H, match_opcode, 0},
{     "xc.scatter.b", 0, {"I",0},    "s,t,r", MATCH_XC_SCATTER_B, MASK_XC_SCATTER_B, match_opcode, 0},
{     "xc.scatter.h", 0, {"I",0},    "s,t,r", MATCH_XC_SCATTER_H, MASK_XC_SCATTER_H, match_opcode, 0},
{      "xc.gather.b", 0, {"I",0},    "d,s,t", MATCH_XC_GATHER_B, MASK_XC_GATHER_B, match_opcode, 0},
{      "xc.gather.h", 0, {"I",0},    "d,s,t", MATCH_XC_GATHER_H, MASK_XC_GATHER_H, match_opcode, 0},
{    "xc.aessub.enc", 0, {"I",0},    "s,t,d", MATCH_XC_AESSUB_ENC, MASK_XC_AESSUB_ENC, match_opcode, 0},
{ "xc.aessub.encrot", 0, {"I",0},    "s,t,d", MATCH_XC_AESSUB_ENCROT, MASK_XC_AESSUB_ENCROT, match_opcode, 0},
{    "xc.aessub.dec", 0, {"I",0},    "s,t,d", MATCH_XC_AESSUB_DEC, MASK_XC_AESSUB_DEC, match_opcode, 0},
{ "xc.aessub.decrot", 0, {"I",0},    "s,t,d", MATCH_XC_AESSUB_DECROT, MASK_XC_AESSUB_DECROT, match_opcode, 0},
{    "xc.aesmix.enc", 0, {"I",0},    "s,t,d", MATCH_XC_AESMIX_ENC, MASK_XC_AESMIX_ENC, match_opcode, 0},
{    "xc.aesmix.dec", 0, {"I",0},    "s,t,d", MATCH_XC_AESMIX_DEC, MASK_XC_AESMIX_DEC, match_opcode, 0},
{       "xc.sha3.xy", 0, {"I",0}, "d,s,t,Xs", MATCH_XC_SHA3_XY, MASK_XC_SHA3_XY, match_opcode, 0},
{       "xc.sha3.x1", 0, {"I",0}, "d,s,t,Xs", MATCH_XC_SHA3_X1, MASK_XC_SHA3_X1, match_opcode, 0},
{       "xc.sha3.x2", 0, {"I",0}, "d,s,t,Xs", MATCH_XC_SHA3_X2, MASK_XC_SHA3_X2, match_opcode, 0},
{       "xc.sha3.x4", 0, {"I",0}, "d,s,t,Xs", MATCH_XC_SHA3_X4, MASK_XC_SHA3_X4, match_opcode, 0},
{       "xc.sha3.yx", 0, {"I",0}, "d,s,t,Xs", MATCH_XC_SHA3_YX, MASK_XC_SHA3_YX, match_opcode, 0},
{     "xc.sha256.s0", 0, {"I",0},      "d,s", MATCH_XC_SHA256_S0, MASK_XC_SHA256_S0, match_opcode, 0},
{     "xc.sha256.s1", 0, {"I",0},      "d,s", MATCH_XC_SHA256_S1, MASK_XC_SHA256_S1, match_opcode, 0},
{     "xc.sha256.s2", 0, {"I",0},      "d,s", MATCH_XC_SHA256_S2, MASK_XC_SHA256_S2, match_opcode, 0},
{     "xc.sha256.s3", 0, {"I",0},      "d,s", MATCH_XC_SHA256_S3, MASK_XC_SHA256_S3, match_opcode, 0},
{     "xc.sha512.s0",64, {"I",0},      "d,s", MATCH_XC_SHA512_S0, MASK_XC_SHA512_S0, match_opcode, 0},
{     "xc.sha512.s1",64, {"I",0},      "d,s", MATCH_XC_SHA512_S1, MASK_XC_SHA512_S1, match_opcode, 0},
{     "xc.sha512.s2",64, {"I",0},      "d,s", MATCH_XC_SHA512_S2, MASK_XC_SHA512_S2, match_opcode, 0},
{     "xc.sha512.s3",64, {"I",0},      "d,s", MATCH_XC_SHA512_S3, MASK_XC_SHA512_S3, match_opcode, 0},

/* Masking instructions */
{         "mask.b2a", 0, {"I",0}, "(XM,XN),(XO,XP)", MATCH_MASK_B2A, MASK_MASK_B2A, match_opcode, 0},
{         "mask.a2b", 0, {"I",0}, "(XM,XN),(XO,XP)", MATCH_MASK_A2B, MASK_MASK_A2B, match_opcode, 0},
{      "mask.b.mask", 0, {"I",0}, "(XM,XN),s", MATCH_MASK_B_MASK, MASK_MASK_B_MASK, match_opcode, 0},
{    "mask.b.unmask", 0, {"I",0}, "d,(XO,XP)", MATCH_MASK_B_UNMASK, MASK_MASK_B_UNMASK, match_opcode, 0},
{    "mask.b.remask", 0, {"I",0}, "(XM,XN),(XO,XP)", MATCH_MASK_B_REMASK, MASK_MASK_B_REMASK, match_opcode, 0},
{      "mask.a.mask", 0, {"I",0}, "(XM,XN),s", MATCH_MASK_A_MASK, MASK_MASK_A_MASK, match_opcode, 0},
{    "mask.a.unmask", 0, {"I",0}, "d,(XO,XP)", MATCH_MASK_A_UNMASK, MASK_MASK_A_UNMASK, match_opcode, 0},
{    "mask.a.remask", 0, {"I",0}, "(XM,XN),(XO,XP)", MATCH_MASK_A_REMASK, MASK_MASK_A_REMASK, match_opcode, 0},
{       "mask.b.not", 0, {"I",0}, "(XM,XN),(XO,XP)", MATCH_MASK_B_NOT, MASK_MASK_B_NOT, match_opcode, 0},
{       "mask.b.and", 0, {"I",0}, "(XM,XN),(XO,XP),(XQ,XR)", MATCH_MASK_B_AND, MASK_MASK_B_AND, match_opcode, 0},
{       "mask.b.ior", 0, {"I",0}, "(XM,XN),(XO,XP),(XQ,XR)", MATCH_MASK_B_IOR, MASK_MASK_B_IOR, match_opcode, 0},
{       "mask.b.xor", 0, {"I",0}, "(XM,XN),(XO,XP),(XQ,XR)", MATCH_MASK_B_XOR, MASK_MASK_B_XOR, match_opcode, 0},
{       "mask.b.add", 0, {"I",0}, "(XM,XN),(XO,XP),(XQ,XR)", MATCH_MASK_B_ADD, MASK_MASK_B_ADD, match_opcode, 0},
{       "mask.b.sub", 0, {"I",0}, "(XM,XN),(XO,XP),(XQ,XR)", MATCH_MASK_B_SUB, MASK_MASK_B_SUB, match_opcode, 0},

{       "mask.b.slli", 0, {"I",0}, "(XM,XN),(XO,XP),>", MATCH_MASK_B_SLLI, MASK_MASK_B_SLLI, match_opcode, 0},
{       "mask.b.srli", 0, {"I",0}, "(XM,XN),(XO,XP),>", MATCH_MASK_B_SRLI, MASK_MASK_B_SRLI, match_opcode, 0},

{       "mask.b.cmov", 0, {"I",0}, "(XM,XN),(XO,XP),(XQ,XR)", MATCH_MASK_B_CMOV, MASK_MASK_B_CMOV, match_opcode, 0},
{       "mask.b.cmpeq", 0, {"I",0}, "(XM,XN),(XO,XP),(XQ,XR)", MATCH_MASK_B_CMPEQ, MASK_MASK_B_CMPEQ, match_opcode, 0},
{       "mask.b.cmpgt", 0, {"I",0}, "(XM,XN),(XO,XP),(XQ,XR)", MATCH_MASK_B_CMPGT, MASK_MASK_B_CMPGT, match_opcode, 0},

{       "mask.a.add", 0, {"I",0}, "(XM,XN),(XO,XP),(XQ,XR)", MATCH_MASK_A_ADD, MASK_MASK_A_ADD, match_opcode, 0},
{       "mask.a.sub", 0, {"I",0}, "(XM,XN),(XO,XP),(XQ,XR)", MATCH_MASK_A_SUB, MASK_MASK_A_SUB, match_opcode, 0},

/* Bitmanip instruction subset */
{"andn",      0, {"I", 0},   "d,s,t",  MATCH_ANDN, MASK_ANDN, match_opcode, 0 },
{"orn",       0, {"I", 0},   "d,s,t",  MATCH_ORN, MASK_ORN, match_opcode, 0 },
{"xnor",      0, {"I", 0},   "d,s,t",  MATCH_XNOR, MASK_XNOR, match_opcode, 0 },
{"grevi",     0, {"I", 0},   "d,s,>",  MATCH_GREVI, MASK_GREVI, match_opcode, 0 },
...
{"rori",      0, {"I", 0},   "d,s,>",  MATCH_RORI, MASK_RORI, match_opcode, 0 },
{"grev",      0, {"I", 0},   "d,s,t",  MATCH_GREV, MASK_GREV, match_opcode, 0 },
{"grev",      0, {"I", 0},   "d,s,>",  MATCH_GREVI, MASK_GREVI, match_opcode, INSN_ALIAS },
...
{"rol",       0, {"I", 0},   "d,s,t",  MATCH_ROL, MASK_ROL, match_opcode, 0 },
// {"rol",    0, {"B", 0},   "d,s,>",  MATCH_ROLI, MASK_ROLI, match_opcode, INSN_ALIAS },   /** TBD **/
{"ror",       0, {"I", 0},   "d,s,t",  MATCH_ROR, MASK_ROR, match_opcode, 0 },
{"ror",       0, {"I", 0},   "d,s,>",  MATCH_RORI, MASK_RORI, match_opcode, INSN_ALIAS },
...
{"cmix",      0, {"I", 0},   "d,t,s,r",  MATCH_CMIX, MASK_CMIX, match_opcode, 0 },
{"cmov",      0, {"I", 0},   "d,t,s,r",  MATCH_CMOV, MASK_CMOV, match_opcode, 0 },
// {"fsli",   0, {"B", 0},   "d,s,r,>",  MATCH_FSLI, MASK_FSLI, match_opcode, 0 },   /** TBD **/
{"fsri",      0, {"I", 0},   "d,s,r,>",  MATCH_FSRI, MASK_FSRI, match_opcode, 0 },
{"fsl",       0, {"I", 0},   "d,s,r,t",  MATCH_FSL, MASK_FSL, match_opcode, 0 },
// {"fsl",    0, {"B", 0},   "d,s,r,>",  MATCH_FSLI, MASK_FSLI, match_opcode, INSN_ALIAS },   /** TBD **/
{"fsr",       0, {"I", 0},   "d,s,r,t",  MATCH_FSR, MASK_FSR, match_opcode, 0 },
{"fsr",       0, {"I", 0},   "d,s,r,>",  MATCH_FSRI, MASK_FSRI, match_opcode, INSN_ALIAS },
...
{"clmul",     0, {"I", 0},   "d,s,t",  MATCH_CLMUL, MASK_CLMUL, match_opcode, 0 },
{"clmulh",    0, {"I", 0},   "d,s,t",  MATCH_CLMULH, MASK_CLMULH, match_opcode, 0 },
{"clmulr",    0, {"I", 0},   "d,s,t",  MATCH_CLMULR, MASK_CLMULR, match_opcode, 0 },
...
{"shfli",     0, {"I", 0},   "d,s,>",  MATCH_SHFLI, MASK_SHFLI, match_opcode, 0 },
{"unshfli",   0, {"I", 0},   "d,s,>",  MATCH_UNSHFLI, MASK_UNSHFLI, match_opcode, 0 },
{"shfl",      0, {"I", 0},   "d,s,t",  MATCH_SHFL, MASK_SHFL, match_opcode, 0 },
{"shfl",      0, {"I", 0},   "d,s,>",  MATCH_SHFLI, MASK_SHFLI, match_opcode, INSN_ALIAS },
{"unshfl",    0, {"I", 0},   "d,s,t",  MATCH_UNSHFL, MASK_UNSHFL, match_opcode, 0 },
{"unshfl",    0, {"I", 0},   "d,s,>",  MATCH_UNSHFLI, MASK_UNSHFLI, match_opcode, INSN_ALIAS },
{"bdep",      0, {"I", 0},   "d,s,t",  MATCH_BDEP, MASK_BDEP, match_opcode, 0 },
{"bext",      0, {"I", 0},   "d,s,t",  MATCH_BEXT, MASK_BEXT, match_opcode, 0 },
{"pack",      0, {"I", 0},   "d,s,t",  MATCH_PACK, MASK_PACK, match_opcode, 0 },
{"bmator",   64, {"I", 0},   "d,s,t",  MATCH_BMATOR, MASK_BMATOR, match_opcode, 0 },
{"bmatxor",  64, {"I", 0},   "d,s,t",  MATCH_BMATXOR, MASK_BMATXOR, match_opcode, 0 },
{"addiwu",   64, {"B", 0},   "d,s,j",  MATCH_ADDIWU, MASK_ADDIWU, match_opcode, 0 },
{"slliu.w",  64, {"B", 0},   "d,s,>",  MATCH_SLLIU_W, MASK_SLLIU_W, match_opcode, 0 },
{"addwu",    64, {"B", 0},   "d,s,t",  MATCH_ADDWU, MASK_ADDWU, match_opcode, 0 },
{"subwu",    64, {"B", 0},   "d,s,t",  MATCH_SUBWU, MASK_SUBWU, match_opcode, 0 },
{"addu.w",   64, {"B", 0},   "d,s,t",  MATCH_ADDU_W, MASK_ADDU_W, match_opcode, 0 },
{"subu.w",   64, {"B", 0},   "d,s,t",  MATCH_SUBU_W, MASK_SUBU_W, match_opcode, 0 },
{"greviw",   64, {"I", 0},   "d,s,>",  MATCH_GREVIW, MASK_GREVIW, match_opcode, 0 },
{"sloiw",    64, {"I", 0},   "d,s,>",  MATCH_SLOIW, MASK_SLOIW, match_opcode, 0 },
{"sroiw",    64, {"I", 0},   "d,s,>",  MATCH_SROIW, MASK_SROIW, match_opcode, 0 },
// {"roliw", 64, {"B", 0},   "d,s,>",  MATCH_ROLIW, MASK_ROLIW, match_opcode, 0 },   /** TBD **/
{"roriw",    64, {"I", 0},   "d,s,>",  MATCH_RORIW, MASK_RORIW, match_opcode, 0 },
{"grevw",    64, {"I", 0},   "d,s,t",  MATCH_GREVW, MASK_GREVW, match_opcode, 0 },
{"grevw",    64, {"i", 0},   "d,s,>",  MATCH_GREVIW, MASK_GREVIW, match_opcode, INSN_ALIAS },
...
{"rolw",     64, {"I", 0},   "d,s,t",  MATCH_ROLW, MASK_ROLW, match_opcode, 0 },
// {"rolw",  64, {"B", 0},   "d,s,>",  MATCH_ROLIW, MASK_ROLIW, match_opcode, INSN_ALIAS },   /** TBD **/
{"rorw",     64, {"I", 0},   "d,s,t",  MATCH_RORW, MASK_RORW, match_opcode, 0 },
{"rorw",     64, {"I", 0},   "d,s,>",  MATCH_RORIW, MASK_RORIW, match_opcode, INSN_ALIAS },
...
{"fsriw",    64, {"I", 0},   "d,s,r,>",  MATCH_FSRIW, MASK_FSRIW, match_opcode, 0 },
{"fslw",     64, {"I", 0},   "d,s,r,t",  MATCH_FSLW, MASK_FSLW, match_opcode, 0 },
// {"fslw",  64, {"B", 0},   "d,s,r,>",  MATCH_FSLIW, MASK_FSLIW, match_opcode, INSN_ALIAS },   /** TBD **/
{"fsrw",     64, {"I", 0},   "d,s,r,t",  MATCH_FSRW, MASK_FSRW, match_opcode, 0 },
{"fsrw",     64, {"I", 0},   "d,s,r,>",  MATCH_FSRIW, MASK_FSRIW, match_opcode, INSN_ALIAS },
...
{"clmulw",   64, {"I", 0},   "d,s,t",  MATCH_CLMULW, MASK_CLMULW, match_opcode, 0 },
{"clmulhw",  64, {"I", 0},   "d,s,t",  MATCH_CLMULHW, MASK_CLMULHW, match_opcode, 0 },
{"clmulrw",  64, {"I", 0},   "d,s,t",  MATCH_CLMULRW, MASK_CLMULRW, match_opcode, 0 },
{"shflw",    64, {"I", 0},   "d,s,t",  MATCH_SHFLW, MASK_SHFLW, match_opcode, 0 },
{"unshflw",  64, {"I", 0},   "d,s,t",  MATCH_UNSHFLW, MASK_UNSHFLW, match_opcode, 0 },
{"bdepw",    64, {"I", 0},   "d,s,t",  MATCH_BDEPW, MASK_BDEP, match_opcode, 0 },
{"bextw",    64, {"I", 0},   "d,s,t",  MATCH_BEXTW, MASK_BEXT, match_opcode, 0 },
{"packw",    64, {"I", 0},   "d,s,t",  MATCH_PACKW, MASK_PACK, match_opcode, 0 },
